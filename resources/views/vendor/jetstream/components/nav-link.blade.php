...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary-500 text-sm md:text-base font-bold leading-5 uppercase text-white focus:outline-none focus:border-primary-700 transition duration-150 ease-in-out'
