                ...
                @if($this->searchableColumns()->count())
                    <div class="w-1/2 flex rounded-lg shadow-sm">
                        <div class="relative flex-grow focus-within:z-10">
                            ...
                            <input wire:model="search" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Suche in Spalte {{ $this->searchableColumns()->map->label->join(', ') }}" />
